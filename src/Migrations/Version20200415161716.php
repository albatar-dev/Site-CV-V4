 ...
 */
final class Version20200415161716 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv CHANGE type_id type_id INT DEFAULT NULL, CHANGE description description VARCHAR(500) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv CHANGE type_id type_id INT DEFAULT NULL, CHANGE description description VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE cv_competence CHANGE cv_id cv_id INT DEFAULT NULL, CHANGE competence_id competence_id INT DEFAULT NULL');
